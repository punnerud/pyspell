...
# The forced-vocab spec (words + Python tokens + delex slot markers) lives in a torch-free
# module so the local embedding precompute / Modal job can build the IDENTICAL BPE.
from vocab_spec import FORCED, PLACEHOLDERS  # noqa: F401  (PLACEHOLDERS re-exported)
